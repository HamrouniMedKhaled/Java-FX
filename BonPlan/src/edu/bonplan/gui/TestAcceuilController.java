 ...
 * @author morrta
 */
public class TestAcceuilController implements Initializable {

    CommentServices cs = new CommentServices();
    @FXML
    private ListView<Pane> badgeList;
    private ObservableList<Pane> badges = FXCollections.observableArrayList();
    public List<Badge> BadList;
    @FXML
    private Menu logout;
    @FXML
    private Button dc;
    ...
    @FXML
    private Button rr;
    public Pane createPane(Badge badge){
        Pane p = new Pane();
        Button b = new Button();
        b.setText(badge.getName());
        b.setPrefWidth(350);
        b.setPrefHeight(75);
        b.setLayoutX(0);
        b.setOnAction((ActionEvent e) -> {
             try {
                Parent p5=FXMLLoader.load(getClass().getResource("/edu/bonplan/gui/BagdeDetail.fxml"));
                Stage stage=new Stage();
                Scene scene = new Scene(p5);
            
                stage.setTitle("Détail du Badge");
    ...
    public void initialize(URL url, ResourceBundle rb) {
        BadList = cs.findUlockedFor(Vars.current_user.getId());
        BadList.forEach(b->{
            Pane p = new Pane();
            p = createPane(b);
            badges.add(p);
            Vars.current_badge= b;
